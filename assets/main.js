...
import { catalogTabActivation, screenForHash, scrollBehaviorForPreference, selectedIdForNavigation, } from "./navigation.js";
...
function main() {
    ...
    function applyNavigation(scroll) {
        ...
        const nextScreen = nextScreenForHash();
        const nextCatalogTab = nextScreen === "detail"
            ? activeCatalogTab
            : (catalogTabFromHash(window.location.hash) ?? activeCatalogTab);
