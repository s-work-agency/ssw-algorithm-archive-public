 ...
 * 상시 경로가 아니다.
 */
export const koreanAlgorithmDisplayNames = {
    "a-star": "A* 알고리즘",
 ...
 */
export const koreanCategoryDisplayNames = {
    automata: "오토마타",
    cache: "캐시",
    concurrency: "동시성",
    "data-structure": "자료구조",
 ...
 */
export const koreanFamilyDisplayNames = {
    comparison: "비교 정렬",
 ...
 */
function lookupDisplayName(table, key) {
 ...
 */
export function algorithmDisplayName(id, englishName, language) {
    if (language === "en")
        return englishName;
...
export function familyDisplayName(family, language) {
    if (language === "en")
        return family;
