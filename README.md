...
[6절](#6-그래서-이-사이트에-이것을-담았습니다)로 건너뛰어도 됩니다.
...
1절에서 말한 "AI 도구를 여럿"의 구체는 **Claude · GPT · Grok** 셋이고, 셋을 함께 쓰면서
**서브에이전트를 동시에 최대 50개까지** 띄워 봤습니다. 그 지점에서는 **CPU · 메모리 · I/O가
거의 풀로드**로 걸렸습니다. 3절에서 적은 재부팅은 그 상태의 다른 단면입니다.
...
서버는 없습니다. 2절에 그린 파이프라인 가운데 **사람이 웹으로 보는 부분만 정적 파일로 만들어
...
이 기능은 [1절](#1-가볍게-시작했습니다)의 출발점과 곧장 이어집니다. "검증된 구현을 참조해 꺼내
...
> 제안을 받기로 정한 것뿐입니다. 1절에서 말한 가이드도 대개 이런 모양이라, 무엇을 만들지 먼저
