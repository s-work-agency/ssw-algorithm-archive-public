...
[7절](#7-그래서-이-사이트에-이것을-담았습니다)로 건너뛰어도 됩니다.
...
> **안다고 생각했던 알고리즘도 막상 계약으로 적으려면 손이 멈춥니다.** 아는 줄 알았던
> 것의 대부분이 문장으로 옮길 만큼 정확한 앎이 아니었던 것입니다. 이해하기 쉬운 기초적인
> 예시를 하나 들면, 교과서적인 설명은 "최단 경로를 구한다"에서 끝나는데, 최단 경로가
> 여럿이면 어느 것을 돌려줄지는 적혀 있지 않습니다. 미리 고민하지 않으면 그 자리는 결국
> 버그로 한 번 마주치고 나서야 고치게 됩니다.
>
...
이미 벌리고 난 뒤에 알았고, 5절의 절차들은 대부분 그 비용을 치르고 나서 사후에 굳힌
것입니다.
...
거의 풀로드**로 걸렸습니다. 4절에서 적은 재부팅은 그 상태의 다른 단면입니다.
