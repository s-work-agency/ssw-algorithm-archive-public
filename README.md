...
사이에서 먼저 드러난다는 점입니다. 열 개 언어로 한꺼번에 벌린 뒤에 계약을 고치면 고칠 곳이
열 배가 됩니다.
...
교과서적인 설명은 "최단 경로를 구한다"에서 끝나는데, 최단 경로가 여럿이면 어느 것을 돌려줄지는
아무도 말해 주지 않습니다. 아무도 말해 주지 않았다는 것은 그 자리를 실은 몰랐다는 뜻이기도
합니다. 구현마다 다르고, 그래서 언어마다 다릅니다.
